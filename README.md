...
To use the UUID and endpoint feature, check "Only Use UUID" in product settings, enter the web address for your custom web api (Out Message). Roll your own api call (example in /models/webApiModel.php) to be called on line 60 of process.php <br />
...
Project last updated 2-1-2024<br />
